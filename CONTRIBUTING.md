# Contributing to QRVerity

Thank you for contributing to QRVerity. To maintain the highest standard of QR correctness, security, and privacy, all contributions must strictly adhere to the project's frozen architecture decisions.
...
5. **No Network Requests**: QRVerity runs 100% client-side. No feature may initiate outbound network requests, dynamic shorteners, or remote assets.
